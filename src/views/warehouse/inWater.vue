<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="入库时间" align="center" sortable prop="price" width="300">
        <template slot-scope="{row}">
      ...
      <el-table-column label="入库量" align="center" prop="capacity" width="100">
        <template slot-scope="{row}">
...
export default {
  ...
  methods: {
    getList() {
      ...
      // allBrand().then((response) => (this.brand = response.data));
      selectInwater(this.listQuery).then((response) => {
